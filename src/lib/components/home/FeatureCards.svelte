...
<section class="py-16 md:py-24 flex flex-col items-center max-w-[1400px] w-full mx-auto px-4 md:px-8">
	...
	<div class="w-full grid grid-cols-1 lg:grid-cols-3 gap-8 items-stretch">
		<div class="p-10 flex flex-col items-center text-center rounded-2xl bg-linear-to-b from-[rgba(16,28,65,0.4)] to-[rgba(10,18,45,0.6)] border border-[rgba(45,65,110,0.4)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.1)] hover:border-white/20">
			...
			<a href="/education" class="w-full flex items-center justify-center gap-3 p-4 bg-white/5 border border-[rgba(45,65,110,0.5)] rounded-lg text-white font-semibold text-[0.85rem] tracking-[0.05em] transition-all hover:bg-white/10 hover:border-white/20">
				ENTER CLASSROOM <ArrowRight size={16} />
			</a>
		</div>

		<div class="p-10 flex flex-col items-center text-center rounded-2xl transition-all duration-300 border border-[#00F0FF]/30 bg-linear-to-b from-[rgba(20,45,90,0.5)] to-[rgba(10,20,50,0.7)] shadow-[0_10px_40px_var(--color-accent-cyan-glow)] lg:-translate-y-3">
			...
			<div class="w-full mb-8">
				...
				<div class="h-1 bg-white/10 rounded-full w-full overflow-hidden">
					<div class="h-full bg-[#00F0FF] rounded-full mx-auto" style="width: 50%;"></div>
				</div>
			</div>

			<a href="/lobby" class="w-full flex items-center justify-center gap-3 p-4 rounded-lg font-bold text-[0.85rem] tracking-[0.05em] transition-all bg-[#00F0FF] text-black shadow-[0_4px_15px_var(--color-accent-cyan-glow)] hover:bg-white hover:scale-[1.02]">
		...
		<div class="p-10 flex flex-col items-center text-center rounded-2xl bg-linear-to-b from-[rgba(16,28,65,0.4)] to-[rgba(10,18,45,0.6)] border border-[rgba(45,65,110,0.4)] transition-all duration-300 hover:-translate-y-1 hover:shadow-[0_10px_30px_rgba(0,0,0,0.5),inset_0_1px_0_rgba(255,255,255,0.1)] hover:border-white/20">
			...
			<div class="flex gap-4 mb-8 w-full justify-center">
				<div class="flex-1 bg-black/20 border border-[rgba(45,65,110,0.5)] rounded-lg p-3 flex flex-col items-center gap-1">
			...
			<a href="/practice" class="w-full flex items-center justify-center gap-3 p-4 bg-white/5 border border-[rgba(45,65,110,0.5)] rounded-lg text-white font-semibold text-[0.85rem] tracking-[0.05em] transition-all hover:bg-white/10 hover:border-white/20">
